...
el perfil metabolómico de muestras de orina de pacientes. A partir de datos obtenidos,
...
entre pacientes con cachexia y controles, se observó que metabolitos como la creatina, 
...
de cachexia, aunque se recomienda un análisis adicional para confirmar estos resultados,
incluyendo la revisión de posibles valores atípicos que podrían estar afectando 
la interpretación.
...
Para profundizar más en nuestro analisis y visto que en la gráfica que se generó con
...
Tras este analisis observamos que creatina, citrato e hipopurato tienen una influncia
